...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark static-top">
    <div class="container">
      <a class="navbar-brand" href="#">KEJAKSAAN NEGERI BOYOLALI</a>
  ...
  <!-- Page Content -->
    ...
    <div class="row">
      <div class="col-lg-12 text-center"><br>
        <h1 class="mt-5">Selamat Datang Di Halaman Administrator</h1><br><br><br>
        <div class="container">
 			<div class="row">
 				<!-- navbar -->
    			<div class="col-sm" >
        ...
        <p class="m-0 text-center">Copyright &copy; Kejaksaan Negeri Boyolali 2024</p>
  			</div>
		</div>
      </div>
    </div>
